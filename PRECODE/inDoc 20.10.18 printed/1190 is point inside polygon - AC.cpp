...
bool isInside(Point polygon[], int n, Point p) {
    ...
    ///very imporatnt line
    ///extreme point was chosen in such a way that there is no integer coordinate between
    ///extreme and point p, so the cases of vertex intersections need not be handled separately.
